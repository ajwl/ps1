...
<div style="width:100%">
  <img src="{{ site.image_base }}/fb-blank-template.jpg" alt="facebook template" style="max-width:100%;" />
</div>
...
<img src="{{ site.image_base }}/gender-dropdown.png" alt="facebook gender dropdown"/>
